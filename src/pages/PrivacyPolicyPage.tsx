        ...
        <div className="space-y-8">
          ...
          <Card>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Service Delivery</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Security & Fraud Prevention</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Service Improvement</h3>
                <p className="text-gray-600 dark:text-gray-300">
          ...
          <Card>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Organizational Measures</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-1">
          ...
          <Card>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Access & Portability</h3>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Rectification</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Erasure</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Objection</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
          ...
          <Card>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Analytics & Monitoring</h3>
                <p className="text-gray-600 dark:text-gray-300">
          ...
          <Card>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
              <div className="space-y-2">
                <p className="text-gray-700 dark:text-gray-300"><strong>Email:</strong> privacy@quiika.com</p>
                <p className="text-gray-700 dark:text-gray-300"><strong>Address:</strong> Portharcourt, Nigeria</p>
                <p className="text-gray-700 dark:text-gray-300"><strong>Response Time:</strong> We respond to privacy inquiries within 72 hours</p>
              </div>
            </div>
          </Card>
