        ...
        <div className="space-y-8">
          ...
          <Card>
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-4 border-orange-500 pl-4 bg-orange-50 dark:bg-orange-900/20 p-4 rounded-r-lg">
                ...
                <p className="text-sm text-orange-700 dark:text-orange-400 mt-2 font-medium">
          ...
          <Card>
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-indigo-500 pl-4 bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-r-lg">
          ...
          <Card>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              ...
              <a href="https://www.allaboutcookies.org" className="text-primary-600 dark:text-primary-400 hover:underline" target="_blank" rel="noopener noreferrer">
