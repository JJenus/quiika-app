...
// import BulkActionsToolbar from '../../components/admin/quid-management/BulkActionsToolbar';
// import ExportQuidsButton from '../../components/admin/quid-management/ExportQuidsButton';
import { LoadingSpinner } from '../../components/ui/LoadingSpinner';
import { Card } from '../../components/ui/Card';
import { Button } from '../../components/ui/Button';

export const QuidManagementPage: React.FC = () => {
	const { fetchQuids, quids, loading, selectedQuids } = useAdminStore(state => ({
		fetchQuids: state.fetchQuids,
		quids: state.quids,
		loading: state.loading,
		selectedQuids: state.selectedQuids,
	}));
		...
		<div className="space-y-6">
			...
			<div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
				...
				<div className="lg:col-span-3 space-y-4">
					...
					<Card>
						{/* {selectedQuids.length > 0 && <BulkActionsToolbar />} */}
