    ...
    <div className="min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          ...
          <Card>
            <div className="flex items-center mb-4">
              <DollarSign className="w-6 h-6 text-primary-600 dark:text-primary-400 mr-3" />
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Financial Terms</h2>
            </div>
            
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Fees and Charges</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-1">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Unclaimed Gifts</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Refund Policy</h3>
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-1">
          ...
          <Card>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Maximum Liability</h3>
                <p className="text-gray-600 dark:text-gray-300">
          ...
          <Card>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">By You</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">By Us</h3>
                <p className="text-gray-600 dark:text-gray-300">
          ...
          <Card>
            <div className="flex items-center mb-4">
              <Gavel className="w-6 h-6 text-primary-600 dark:text-primary-400 mr-3" />
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Governing Law and Disputes</h2>
            </div>
            
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Applicable Law</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Dispute Resolution</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-2">
          ...
          <Card>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
              <div className="space-y-2">
                <p className="text-gray-700 dark:text-gray-300"><strong>Email:</strong> legal@quiika.com</p>
                <p className="text-gray-700 dark:text-gray-300"><strong>Address:</strong> Portharcourt, Nigeria</p>
                <p className="text-gray-700 dark:text-gray-300"><strong>Response Time:</strong> We respond to legal inquiries within 5 business days</p>
              </div>
            </div>
          </Card>
        </div>
