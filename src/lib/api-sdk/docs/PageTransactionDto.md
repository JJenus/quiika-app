...
**content** | [**Array&lt;TransactionDto&gt;**](TransactionDto.md) |  | [optional] [default to undefined]
**empty** | **boolean** |  | [optional] [default to undefined]

## Example

```typescript
import { PageTransactionDto } from '@app/api-sdk';

const instance: PageTransactionDto = {
    totalElements,
    totalPages,
    pageable,
    sort,
