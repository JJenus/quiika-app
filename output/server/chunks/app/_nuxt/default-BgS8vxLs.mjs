import { u as useRuntimeConfig, d as useRoute, a as useAppSettings } from '../server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-2e424684><div class="d-flex flex-column flex-root app-root" id="kt_app_root" data-v-2e424684><div class="app-page flex-column flex-column-fluid" id="kt_app_page" data-v-2e424684>`);
      _push(ssrRenderComponent(_component_Header, { class: "mb-10" }, null, _parent));
      _push(`<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper" data-v-2e424684><div class="app-main flex-column flex-row-fluid" id="kt_app_main" data-v-2e424684><div class="d-flex flex-column flex-column-fluid" data-v-2e424684><div id="kt_app_content" class="app-content flex-column-fluid" data-v-2e424684><div class="mb-3 container" data-v-2e424684></div><div style="${ssrRenderStyle({ "position": "relative" })}" id="kt_app_content_container" class="app-container position-relative" data-v-2e424684>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></div></div>`);
      _push(ssrRenderComponent(_component_Footer, null, null, _parent));
      _push(`</div></div></div></div><div id="kt_scrolltop" class="scrolltop" data-kt-scrolltop="true" data-v-2e424684><i class="ki-outline ki-arrow-up" data-v-2e424684></i></div></div>`);
    };
  }
};
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2e424684"]]);

export { _default as default };
//# sourceMappingURL=default-BgS8vxLs.mjs.map
