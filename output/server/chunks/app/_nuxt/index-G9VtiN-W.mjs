...
import { useSSRContext, defineComponent, ref, watch, mergeProps, withCtx, createVNode, toDisplayString, unref, computed } from 'vue';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "card card-custom border-0 h-md-100 mb-5 mb-lg-10" }, _attrs))}><div class="card-body d-flex align-items-center justify-content-center flex-wrap px-auto gap-8 gap-md-10"><div class="flex-grow-1 mt-2 me-9 me-md-6 mb-8"><div class="mb-5"><h1 class="display-6"> Add<span class="text-success"> Rules</span> to Quid </h1><h6 class="text-muted"> Control how your gift is accessed and distributed. </h6></div><form class="h-100"><div class="mb-5"><label class="form-label required fw-bold">Rule Type</label><div class="btn-group w-100" role="group"><button type="button" class="${ssrRenderClass([
        "btn",
        unref(ruleState).ruleType === "nth_person" ? "btn-primary" : "btn-outline-primary"
      ])}"> Nth Person </button><button type="button" class="${ssrRenderClass([
        "btn",
        unref(ruleState).ruleType === "split" ? "btn-primary" : "btn-outline-primary"
      ])}"> Split </button><button type="button" class="${ssrRenderClass([
        "btn",
        unref(ruleState).ruleType === "time" ? "btn-primary" : "btn-outline-primary"
      ])}"> Time Range </button></div></div>`);
      ...
      _push(`<div class="d-flex gap-3"><button type="button" class="btn btn-secondary flex-grow-1"> Cancel </button><button type="submit" class="btn btn-primary flex-grow-1"${ssrIncludeBooleanAttr(!isValid.value) ? " disabled" : ""}>${ssrInterpolate(__props.currentRules.length ? "Update Rule" : "Add Rule")}</button></div></form></div><div class="h-175px mx-auto"><i class="ki-duotone ki-gear text-success" style="${ssrRenderStyle({ "font-size": "13rem" })}"><i class="path1"></i><i class="path2"></i></i></div></div></div>`);
    };
  }
});
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></ul></div><div class="card-body" bis_skin_checked="1"><div class="tab-content" bis_skin_checked="1"><div class="${ssrRenderClass([{ "active show": activeTab.value === "send" }, "tab-pane fade"])}" role="tabpanel" bis_skin_checked="1">`);
      ...
      _push(`</div><div class="${ssrRenderClass([{ "active show": activeTab.value === "rules" }, "tab-pane fade"])}" role="tabpanel" bis_skin_checked="1">`);
...
//# sourceMappingURL=index-G9VtiN-W.mjs.map
